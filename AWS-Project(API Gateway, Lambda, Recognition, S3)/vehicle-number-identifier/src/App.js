...
const bucketName = "vehicle-image-bucket-vivek"
const creds = {
  accessKeyId: "<accessKey>",  
  secretAccessKey: "<secretAccessKEet>",
};
...
function App() {
  ...
  useEffect(() => {
    if(!ws){
      ...
      const webSocket = new WebSocket("wss://g0wm6td3yh.execute-api.ap-south-1.amazonaws.com/dev/");
      setWs(webSocket)     
    } else{
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h3>Vehicle Number Plate Recognition</h3>
